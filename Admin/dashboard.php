...
<body>
  ...
  <div class="container">
    <div class="row column-gap-3 p-3 ms-3">
      <a class="col-2 mb-2 mt-5 btn btn-success fw-bold text-nowrap" href="create.php"> + Tambah Produk</a>
      <a class="col-2 mb-2 mt-5 btn btn-success fw-bold text-nowrap" href="dataPenjualan.php"><i class="bi bi-receipt-cutoff"></i> Data Penjualan</a>
