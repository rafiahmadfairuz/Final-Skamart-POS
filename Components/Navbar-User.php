         ...
         <div class="d-flex align-items-center ">
             <?php if (isset($_SESSION['username'])): ?>
                 ...
                 <div class="offcanvas offcanvas-bottom" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
                     ...
                     <div class="offcanvas-body " id="keranjang"></div>
                 ...
                 <div class="dropdown-center">
                     ...
                     <ul class="dropdown-menu dropdown-menu-end  dropdown-menu-light border shadow-sm">
                         ...
                         <li><a class="dropdown-item d-flex align-items-center" href="historyPembelian.php"><i class="bi bi-cash-coin mx-2"></i>History Pembelian</a></li>
                         <li>
                             <hr class="dropdown-divider">
                            </li>
     ...
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 <button type="button" data-bs-dismiss="modal" class="btn btn-success">Oke</button>
             </div>
         </div>
     </div>
 </div>
